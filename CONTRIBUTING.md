...
Community contributions are what make open-source projects thrive. Whether you are fixing a typo, writing a new tutorial, updating our 3D file formats guide, or submitting a new listing for the 3D and CG events directory, your help is incredibly valuable.

> **Note:** This repository is strictly for the PoseStudio website and documentation (`posestudio.org`). If you want to contribute to the core 3D character and animation software, please visit our **[Main Application Repository Link]**.
